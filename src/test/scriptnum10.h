...
#ifndef FOXDCOIN_TEST_SCRIPTNUM10_H
#define FOXDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Foxdcoin Core 0.10.0, for cross-comparison.
 */
public:
