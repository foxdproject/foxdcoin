...
#ifndef FOXDCOIN_ASSET_PROTOCOL_H
#define FOXDCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_FOXDCOIN_ASSET FOXDQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_FOXDCOIN_ASSET FOXDO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_FOXDCOIN_ASSET FOXDR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_FOXDCOIN_ASSET FOXDT
...
#endif //FOXDCOIN_ASSET_PROTOCOL_H
