...
#ifndef FOXDCOIN_SCRIPT_STANDARD_H
#define FOXDCOIN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_FOXDCOIN_ASSET script that carries data
    /** FOXD END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a foxdcoin address
 */
...
/**
 * Generate a Foxdcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // FOXDCOIN_SCRIPT_STANDARD_H
