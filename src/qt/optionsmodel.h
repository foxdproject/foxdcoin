...
#ifndef FOXDCOIN_QT_OPTIONSMODEL_H
#define FOXDCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Foxdcoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // FoxdcoinUnits::Unit
...
#endif // FOXDCOIN_QT_OPTIONSMODEL_H
