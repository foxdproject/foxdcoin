...
#ifndef FOXDCOIN_QT_GUIUTIL_H
#define FOXDCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Foxdcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "foxdcoin:" URI into recipient object, return true on successful parsing
