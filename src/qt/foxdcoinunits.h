...
#ifndef FOXDCOIN_QT_FOXDCOINUNITS_H
#define FOXDCOIN_QT_FOXDCOINUNITS_H
...
/** Foxdcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FoxdcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FoxdcoinUnits(QObject *parent);

    /** Foxdcoin units.
      @note Source: https://en.foxdcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FOXD,
...
typedef FoxdcoinUnits::Unit FoxdcoinUnit;

#endif // FOXDCOIN_QT_FOXDCOINUNITS_H
