...
#include "qt/foxdcoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<FoxdcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_foxdcoin-qt -platform xcb      # Linux
//     src/qt/test/test_foxdcoin-qt -platform windows  # Windows
//     src/qt/test/test_foxdcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = FoxdcoinUnits::formatWithUnit(unit, balance, false, FoxdcoinUnits::separatorAlways);
    ...
    // Amount input
    FoxdcoinAmountField* amountInput = receiveCoinsDialog.findChild<FoxdcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: foxdcoin:")) != -1);
