...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(FoxdcoinUnits::FOXD),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(FoxdcoinUnits::formatWithUnit(unit, balance, false, FoxdcoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(FoxdcoinUnits::formatWithUnit(unit, unconfirmedBalance, false, FoxdcoinUnits::separatorAlways));
    ui->labelImmature->setText(FoxdcoinUnits::formatWithUnit(unit, immatureBalance, false, FoxdcoinUnits::separatorAlways));
    ui->labelTotal->setText(FoxdcoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, FoxdcoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(FoxdcoinUnits::formatWithUnit(unit, watchOnlyBalance, false, FoxdcoinUnits::separatorAlways));
    ui->labelWatchPending->setText(FoxdcoinUnits::formatWithUnit(unit, watchUnconfBalance, false, FoxdcoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(FoxdcoinUnits::formatWithUnit(unit, watchImmatureBalance, false, FoxdcoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(FoxdcoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, FoxdcoinUnits::separatorAlways));
