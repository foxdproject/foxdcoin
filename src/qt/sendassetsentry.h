...
#ifndef FOXDCOIN_QT_SENDASSETSENTRY_H
#define FOXDCOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending foxdcoins.
...
#endif // FOXDCOIN_QT_SENDASSETSENTRY_H
