...
#ifndef FOXDCOIN_QT_FOXDCOINGUI_H
#define FOXDCOIN_QT_FOXDCOINGUI_H
...
/**
  Foxdcoin GUI main class. This class represents the main window of the Foxdcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FoxdcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FoxdcoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~FoxdcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a foxdcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // FOXDCOIN_QT_FOXDCOINGUI_H
