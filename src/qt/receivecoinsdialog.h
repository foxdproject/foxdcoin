...
#ifndef FOXDCOIN_QT_RECEIVECOINSDIALOG_H
#define FOXDCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of foxdcoins */
...
#endif // FOXDCOIN_QT_RECEIVECOINSDIALOG_H
