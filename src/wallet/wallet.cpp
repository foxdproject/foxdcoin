...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListAssets() const
{
    ...
    // https://github.com/FoxdcoinProject/Foxdcoin/pull/10340, but that change has been
    // postponed until after https://github.com/FoxdcoinProject/Foxdcoin/pull/10244 to
                                   ...
                                   const AssetType& assetType, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-foxdcoin-address
 ...
 * https://foxdcointalk.org/?topic=54527, or
 * https://github.com/FoxdcoinProject/Foxdcoin/pull/1393.
 */
