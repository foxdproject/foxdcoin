...
#ifndef FOXDCOIN_WALLET_WALLET_H
#define FOXDCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this foxdcoin node, and set to 0 for transactions that were created
...
#endif // FOXDCOIN_WALLET_WALLET_H
