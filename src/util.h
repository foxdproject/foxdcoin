 ...
 */
#ifndef FOXDCOIN_UTIL_H
#define FOXDCOIN_UTIL_H
...
extern const char *const FOXDCOIN_CONF_FILENAME;
extern const char *const FOXDCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("foxdcoin-%s", name);
