...
"""
    ...
    Foxdcoin should be started with the command line arguments:
        foxdcoind -testnet -daemon \
    ...
    https://github.com/FoxdcoinProject/Foxdcoin/blob/37a7fe9e440b83e2364d5498931253937abe9294/contrib/zmq/zmq_sub.py
"""
