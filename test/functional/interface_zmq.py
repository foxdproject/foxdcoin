...
import os
import struct
from test_framework.test_framework import FoxdcoinTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest (FoxdcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that foxdcoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("foxdcoind has not been built with zmq enabled.")
