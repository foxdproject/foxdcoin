...
By default, foxdcoind will dump mempool on shutdown and
...
class MempoolPersistTest(FoxdcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give foxdcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent foxdcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
