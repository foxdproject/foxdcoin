...
class AssetTest(FoxdcoinTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("FOXDCOIN1", 1000)
        n0.issue("FOXDCOIN2", 1000)
        n0.issue("FOXDCOIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="FOXDCOIN*", verbose=False, count=2, start=-2)
        ...
        foxdcoin_assets = n0.listassets(asset="FOXDCOIN*", verbose=False, count=2, start=-2)
        assert_equal(len(foxdcoin_assets), 2)
        assert_equal(foxdcoin_assets[0], "FOXDCOIN2")
        assert_equal(foxdcoin_assets[1], "FOXDCOIN3")
        self.sync_all()
