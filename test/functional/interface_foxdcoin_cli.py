...
class TestFoxdcoinCli(FoxdcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `foxdcoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `foxdcoin-cli -getinfo` and the RPCs data is retrieved from.")
