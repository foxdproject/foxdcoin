...
class BIP66Test(FoxdcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # foxdcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and foxdcoind produces more specific reject
            # reasons.
