...
# TestNode: A peer we use to send messages to foxdcoind, and store responses.
...
class CompactBlocksTest(FoxdcoinTestFramework):
    ...
    # This test actually causes foxdcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that foxdcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for foxdcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # foxdcoind will not send blocktxn responses for blocks whose height is
