...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FoxdcoinTestFramework
    pass

class ExampleTest(FoxdcoinTestFramework):
    # Each functional test is a subclass of the FoxdcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        FoxdcoinTestFramework class so other tests can use it."""
