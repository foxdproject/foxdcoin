## Foxdcoin Metadata Specification

Additional fields may be added, but will be ignored by Foxdcoin.
...
```
{
   ...
   "contract_signature": "<Foxdcoin signed contract_hash>",
